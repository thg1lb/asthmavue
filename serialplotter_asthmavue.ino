...
void loop() {
    ...
    // Output data for SerialPlot
    Serial.print(energy);        // Total energy
    Serial.print(",");           // Delimiter
    Serial.print(peakFrequency); // Peak frequency
    Serial.print(",");           // Delimiter
    Serial.println(wheezeDetected); // Detection status (1 or 0)
